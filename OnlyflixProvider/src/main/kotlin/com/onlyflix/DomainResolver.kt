 ...
 * into another provider's module (as done here, from FrameMovieProvider) rather than shared via a
 * Gradle module dependency, since each provider here already compiles to its own independent
 * .cs3 and none of them depend on another provider's module.
 */
