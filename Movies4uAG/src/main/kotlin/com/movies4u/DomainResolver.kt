 ...
 *
 * Provider-agnostic and self-contained on purpose - this file is copied verbatim from
 * VidboxProvider rather than shared via a Gradle module dependency, since each provider here
 * already compiles to its own independent .cs3 and none of them depend on another provider's
 * module.
 */
